...
/**
 * Naming: A traveler travels between point A to point B without regards to any direction. So a traveler can walk 
 * (direction-less) or run (has direction), so the subclasses are implemented similarly. 
 * 
 ...
 * of more restrictive/specialized functionality from parent to child. So in essence a runner is also a walker.
 * 
 * @author deepak.tripathy
 *
 */
public interface IElementTraveler {
